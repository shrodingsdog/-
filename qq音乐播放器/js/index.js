$(function() {
	...
	function initMusicInfo(music) {
		...
		var $musicProessName = $(".music_progress_name");
		var $musicProessTime = $(".music_progress_time");
		var $musicBg = $(".mask_bg");
		...
		$musicProessName.text(music.name + " / " + music.singer);
		$musicProessTime.text("00:00 / " + music.time);
